...
from config.rest_api_config import *
...
class APIConfig():
    ...
    def _load_path(self,filename):
        ...
        #print(self.config_dir,self.conf_file)
        
    def load(self,filename=None):
        if filename is None:
            self.config = self._load_default_rest_api_config()
        else:
            self.config_file = self._load_path(filename)
            self.config = self._load_toml_rest_api_config(self.config_file)

        return self.config

    def _load_default_rest_api_config(self):
    ...
    def _load_toml_rest_api_config(self,filename):
    ...
    def _merge_rest_api_config(self,configs):
        """
