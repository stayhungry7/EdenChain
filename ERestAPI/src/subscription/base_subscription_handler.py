...
from messaging import ConnectionEvent
from messaging import DisconnectError
from protobuf import client_list_control_pb2
from protobuf import client_block_pb2
from protobuf import client_event_pb2
from protobuf import events_pb2
from protobuf import transaction_receipt_pb2
            ...
            if self._delta_task and not self._subscribers:
                ...
                try:
                    await self._connection.send(
                        ...
                        timeout=DEFAULT_TIMEOUT_SUBSCRIPTION)
